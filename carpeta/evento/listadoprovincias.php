...
<head>
	...
	<title>Listado de regiones y provincias</title>
...
<body>
	...
	<div class="row" id="principal">
		...
		<div class="col-sm-10" id="contenido">
			...
			b.des_provincia from region a,provincia b
			where a.cod_region=b.cod_region;";
			$resultado=EjecutarConsulta($CadSql,$link);
			?>
			<div class="row">
				<div class="col-sm-3">Código región</div>
				<div class="col-sm-3">Nombre región</div>
				<div class="col-sm-3">Código provincia</div>
				<div class="col-sm-3">Nombre provincia</div>
			</div>
			<?php 		
			...
			<div class="row">
				<div class="col-sm-2"></div>
				<div class="col-sm-4">Total provincias</div>
				<div class="col-sm-4">
					<b> <?php echo $fila["total"];?> </b>
				</div>
				<div class="col-sm-2"></div>
